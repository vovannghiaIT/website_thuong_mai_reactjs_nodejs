        ...
        <div className="flex justify-between  gap-5">
          <div className="flex flex-col gap-5 w-[70%] items-start">
            ...
            <div className="w-full p-5 mb-5 bg-white  flex flex-col justify-start items-start relative shadow-10% rounded-xl">
              <span className="font-semibold text-[16px] capitalize text-red-600">
                thông tin cá nhân
              </span>
              <span>
                Họ và tên: {currentData?.firstName + currentData?.lastName}
              </span>
              <span>Email: {currentData?.email}</span>
              <span>Số điện thoại:{currentData?.phone}</span>
            </div>
          </div>
          <div className="w-[30%]">
